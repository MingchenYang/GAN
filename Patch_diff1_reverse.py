# Get the threhold in whole sequence 199 images used in Unet_optflow_reverse project
import os
import cv2
import math
import numpy as np
...
Result_dir = 'S:/pix2pix optflow/Test256/Unet_reverse_test/'
Label_dir = 'S:/pix2pix optflow/Test256/label/'
Image_dir = 'S:/pix2pix optflow/Test256/training/'
Output_dir = 'S:/pix2pix optflow/Test256/Unet_reverse_test_mask/'
...
def train():
    ...
    for num_sequence in range(Num_video):
        ...
        for num_image in range(Num_image_per):
            ...
            Result_path = Result_dir + Result_name
            Label_path = Label_dir + Result_name
            Image_path = Image_dir + Result_name
            ...
            Image_3C = np.concatenate([Image, Image, Image], -1)
            ...
            beta = 1.0
            gamma = 0
            img_mask = cv2.addWeighted(Image_3C, alpha, mask, beta, gamma)
