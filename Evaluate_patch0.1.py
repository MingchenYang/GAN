...
Num_video = 36
Num_video_per = [200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200,
                 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200]
Total_video_frames = sum(Num_video_per) - Num_video

Input_dir = 'S:/UCSD_ped1/Test256/Unet_Reverse_test_diff/'
Label_path = 'S:/UCSD_ped1/Test256/Ped1_label.mat'
Output_dir = 'S:/UCSD_ped1/Test256/Unet_Mosaic_est_diff_mask/'
...
def main(argv=None):
    for i in np.arange(0.03, 1.0, 0.005):
