...
def Discriminator():
    input = tf.keras.Input(shape=[L_node, W_node, Channel * 6])
...
def train():
    ...
    generator = Generator()
    generator.build(input_shape=(Batch_size, L_node, W_node, Channel * 3))
    generator.summary()

    discriminator = Discriminator()
    discriminator.build(input_shape=(Batch_size, L_node, W_node, Channel * 6))
